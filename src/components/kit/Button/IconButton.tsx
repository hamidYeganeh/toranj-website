...
// types
import { IIconButton } from "./Button.types";
// variants
import { ButtonColors, IconButtonVariants } from "./Button.variants";

const IconButton = forwardRef<HTMLButtonElement, IIconButton>((props, ref) => {
    const { variant, className, children, color, size, shadow, ...otherProps } =
        props;
