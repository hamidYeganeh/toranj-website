...
export const ButtonVariants = cva(
    "w-fit rounded flex items-center justify-center font-bold transition-all duration-300 outline-none",
    {
        variants: {
            variant: {
...
export const ButtonColors = {
    primary: {
        contained:
            "bg-primary-500 text-text-secondary hover:bg-primary-700",
        outlined:
    ...
    tertiary: {
        contained:
            "bg-tertiary-500 text-text-secondary hover:bg-tertiary-700",
        outlined:
    ...
    success: {
        contained:
            "bg-success-main text-text-secondary hover:bg-success-dark",
        outlined:
    ...
    error: {
        contained:
            "bg-error-main text-text-secondary hover:bg-error-dark",
        outlined:
    ...
    warning: {
        contained:
            "bg-warning-main text-text-secondary hover:bg-warning-dark",
        outlined:
    ...
    info: {
        contained:
            "bg-info-main text-text-secondary hover:bg-info-dark",
        outlined:
